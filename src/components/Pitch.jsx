import { LazyMotion, m, useScroll, useTransform, useSpring } from "framer-motion";
  ...
  return (
    <LazyMotion features={loadMotionFeatures}>
      ...
      >
        ...
        >
          <m.h2 variants={paragraph} className="mb-6 text-left font-display">
            Votre enfant, <br />
          ...
          <m.div variants={paragraph} className="pt-6">
