  ...
  return (
    ...
    <div className="py-12 px-6">
      <Helmet>
        ...
        <meta
          name="description"
          content="Consultez les CGU-CGV de Minimoji : conditions d’utilisation, droits d’auteur, modalités de commande, délais, annulations, et politique d’IA pour un service transparent et sécurisé."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Conditions Générales d’Utilisation et de Vente - Minimoji" />
        <meta
          property="og:description"
          content="Consultez les CGU-CGV de Minimoji : conditions d’utilisation, droits d’auteur, modalités de commande, délais, annulations, et politique d’IA."
        />
      ...
      <div className={wrapperClasses}>
        ...
        <h2 className={headingClasses}>Champ d’application</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Description du service</h2>
        <p>
        ...
        <h2 className={headingClasses}>Format et livraison des vidéos</h2>
        <p>
        ...
        <h2 className={headingClasses}>Usage autorisé</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Licence d’utilisation et droits cédés</h2>
        <p>
        ...
        <h2 className={headingClasses}>Nature du service</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Acceptation des conditions</h2>
        <p>
        ...
        <h2 className={headingClasses}>Commande et paiement</h2>
        <p>
          Le processus de commande se déroule directement via le formulaire en ligne accessible sur la page{' '}
          <a href="/creer" className="text-orange-500 font-semibold hover:underline">
            Créer mon dessin animé
          </a>
          . L’utilisateur est invité à fournir les informations nécessaires à la personnalisation de son animation, ainsi qu’à procéder au paiement sécurisé par carte bancaire via la plateforme Stripe. La commande est considérée comme valide uniquement après réception du paiement complet.
        </p>
        <h2 className={headingClasses}>Tarifs et promotions</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Délai de réalisation</h2>
        <p>
        ...
        <h2 className={headingClasses}>Rétractation et annulation</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Réclamation et médiation</h2>
        <p>
        ...
        <h2 className={headingClasses}>Responsabilités</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Contenus refusés ou inappropriés</h2>
        <p>
        ...
        <h2 className={headingClasses}>Droit applicable et litiges</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Modification des CGU-CGV</h2>
        <p>
        ...
        <h2 className={headingClasses}>Usage de l’intelligence artificielle</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Service client et contact</h2>
        <p>
        ...
        <h2 className={headingClasses}>Archivage et preuve</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Force majeure</h2>
        <p>
        ...
        <h2 className={headingClasses}>Indépendance des clauses</h2>
        <p>
      ...
      <div className={wrapperClasses}>
        <h2 className={headingClasses}>Entrée en vigueur</h2>
        <p>
